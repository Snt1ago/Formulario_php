        ...
        <section class="formulario">
            <fieldset class="fie fie-1">
                ...
                <form id="form" action="procesar.php" target="_self" method="post">
                    ...
                    <input id="nombre" type="text" name="nombre" required pattern="[A-Za-z]+" title="solo letras, por favor" placeholder="">
                    <label class="label label-2" for="hidden">
                        Vacio:
                    </label>
                    <input id="hidden" type="hidden" name="hidden" required pattern="[A-Za-z]+" title="solo letras, por favor" placeholder="" value="pepe">
                    <fieldset>
                        <legend>
                            Opciones:
                        </legend>
